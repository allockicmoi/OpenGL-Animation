...
public class NeckCylinder extends GraphNode {
	...
	public NeckCylinder(String name,double scale_x,double scale_y,double scale_z,double x, double y, double z,double radius,int slices,int stacks,double height) {
		super(name);
		this.x=x;
		this.y=y;
		this.z=z;
